...
This outlines how to propose a change to ubep.azure. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("UBESP-DCTV/ubep.azure", fork = TRUE)`.
...
Code of
Conduct](https://ubesp-dctv.github.io/ubep.azure/CODE_OF_CONDUCT.md). By
