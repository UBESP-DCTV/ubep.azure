...
Thanks for using ubep.azure! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/UBESP-DCTV/ubep.azure/issues/new).
...
requests](https://github.com/UBESP-DCTV/ubep.azure/issues) to make sure
